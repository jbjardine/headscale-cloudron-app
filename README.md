...
```sh
cloudron install --location headscale --image ghcr.io/jbjardine/headscale-cloudron-app:v0.28.0-21
```

## Release Process

1. Update `CloudronManifest.json`, `CloudronVersions.json`, and `CHANGELOG.md` for the new package version.
2. Create and push a matching Git tag, for example `v0.28.0-21`.
...
```sh
docker build -t ghcr.io/jbjardine/headscale-cloudron-app:v0.28.0-21 .
```
